...
@endphp
@section('content')
    <h1 class="mt-4">Data Anggota Honorer</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">List Semua Data Anggota Honorer</li>
    </ol>
    <div class="row">
