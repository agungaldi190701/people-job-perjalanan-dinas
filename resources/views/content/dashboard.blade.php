...
<body>
    ...
    <header id="header" class="header d-flex align-items-center">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="/" class="logo d-flex align-items-center">
                ...
                <img src="{{ asset('img/logoSamarinda.png') }}" alt="">
                <h1>KOTA SAMARINDA<span></span></h1>
            </a>
    ...
    <section id="hero" class="hero">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <h2 data-aos="fade-down">DINAS PERPUSTAKAAN KOTA SAMARINDA</h2>


                        <!-- Button trigger modal -->
                        <button data-aos="fade-up" data-aos-delay="200" type="button" class="btn btn-get-started"
                            data-bs-toggle="modal" data-bs-target="#exampleModal">
                            VISI DAN MISI
                        </button>
                        <a data-aos="fade-up" data-aos-delay="200" href="/login" class="btn-get-started">Sign
                            in</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p data-aos="fade-up">Visi</p>
                        <p data-aos="fade-up">Terwujudnya masyarakat cerdas melalui gemar membaca
                            dengan
                            memberdayakan
                            perpustakaan</p>
                        <p data-aos="fade-up">Misi</p>
                        <p data-aos="fade-up">1. Mewujudkan koleksi perpustakaan yang lengkap dan mutakhir.</p>
                        <p data-aos="fade-up">2. Pengembangan diverdifikasi layanan perpustakaan berbasis teknologi
                            informasi dan
                            komunikasi.</p>
                        <p data-aos="fade-up">3. Mengembangkan perpustakaan yang dapat menjangkau masyarakat luas.</p>
                        <p data-aos="fade-up">4. Mewujudkan tenaga perpustakaan yang kompeten dan profesional.</p>
                        <p data-aos="fade-up">5. Menggelakkan sosisalisasi, promosi dan pemasyarakatan gemar membaca.
                        </p>
                        <p data-aos="fade-up">6. Mengembangkan infrastruktur perpustakaan yang modern.</p>
                    </div>
        ...
        <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-item active" style="background-image: url({{ asset('img/perpus.png') }})"></div>
